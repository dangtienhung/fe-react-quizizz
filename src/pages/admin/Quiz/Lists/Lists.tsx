import { BsCheckSquare, BsFillImageFill, BsListCheck, BsPencilFill, BsTrash3 } from 'react-icons/bs'
                        ...
                        <div className={`grid grid-cols-2 gap-4 px-2 py-5`}>
                          {question.questionAnswers &&
                            question.questionAnswers.map((answer) => (
                              <div className='flex items-center gap-2 truncate' key={answer._id}>
                                <div
