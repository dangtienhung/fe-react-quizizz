  ...
  return (
    <>
      ...
      >
        ...
        <div className='p-3'>
          <h2 className='line-clamp-2 text-base font-medium capitalize'>{quizizzExam.title}</h2>
        </div>
      </div>
      <Modal
        dismissible
        ...
        size={'lg'}
      >
        <div className='relative h-[240px] select-none' style={{ width: '100%' }}>
          <img
            src='https://yeudayhoc.com/wp-content/uploads/2022/01/8-1.png'
            alt='image'
            className='object-cover w-full h-full rounded-t-lg'
        ...
        <div className='p-3 select-none'>
          ...
          <div className='flex items-center justify-between gap-4'>
            <Link to={`/join/quiz/${quizizzExam._id}`} className='inline-block w-full border-none outline-none'>
